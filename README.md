...
- **Terminal 7 – Frontend UI**
  ...
  ```
  💡 **Tip:** Use `npm run dev -- --port 3000` (double dashes) to pass the port flag to Vite; `npm run dev --port 3000` doesn’t work because the flag must be forwarded to the underlying Vite command.
