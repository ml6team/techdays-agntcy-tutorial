...
const Sidebar: React.FC = () => {
  return (
    <div className="bg-sidebar-background border-sidebar-border flex h-full w-64 flex-none flex-col border-r font-inter lg:w-[320px]">
      <div className="flex h-full flex-1 flex-col gap-5 p-4">
        <div className="flex flex-col">
          <div className="flex min-h-[36px] w-full items-center gap-2 rounded p-2">
            <span className="text-sidebar-text flex-1 text-sm font-normal leading-5 tracking-wide">
